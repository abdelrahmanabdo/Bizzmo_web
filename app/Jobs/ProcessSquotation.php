...
class ProcessSquotation implements ShouldQueue
{
	...
	public function handle()
	{
		...
		Mail::send('emails.squotation', $data, function ($message) use ($path, $filename, $squotation) {
			$message->subject('We have received your Quote # ' . $squotation);
