...
<p>
	...
	<br/><br/>
	We'd like to thank you again for your order. Your order # {{ $purchaseorder->company_id }}-{{ $purchaseorder->number }} (ver. {{ $purchaseorder->version }}) has now been accepted! Below you will find your order details.
	<br/><br/>
