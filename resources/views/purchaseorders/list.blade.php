								...
								<tr>
									<td>
										@if ($company->vendors->count() > 0)
											<a href="/purchaseorders/create/{{ $company->id }}"  role="button"><span class="glyphicon glyphicon-plus" title="Create PO"></span></a>	
										@else
											<a href="/companies/mysuppliers/{{ $company->id }}"  role="button"><span class="glyphicon glyphicon-star-empty" title="Add favorite suppliers"></span></a>	
										@endif
									</td>
