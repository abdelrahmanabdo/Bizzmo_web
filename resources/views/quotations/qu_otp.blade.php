                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="bm-sublabel text-center" style="margin-bottom: 10px;margin-top: 10px">
							@if ($usertype == 'buyer')
								If you did not recieve a verification code please click <a href="/quotations/resend/{{ $qu_id }}" >here</a>
							@else
								If you did not recieve a verification code please click <a href="/quotations/vresend/{{ $qu_id }}" >here</a>
							@endif
                        </div>

                        <!-- Saving the value of the verification token -->
                        <input id="qu_id" type="text" class="hidden form-control" name="qu_id" value="{{ $qu_id }}">
