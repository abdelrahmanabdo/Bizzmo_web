...
@section('content')
	...
	<div class="row-fluid">	<!-- row 1 -->		
		...
		<div class="col-md-4">  <!-- column 4 -->
			<div class="form-group text-input"> <!-- vendor -->  
				{{ Form::label('quotation_status', 'Status',array('class' => isset($mode) ? 'control-label bm-label col-sm-4':'form-label')) }}
				{{ Form::select('quotation_status', $quotationStatuses, Input::get('quotation_status'),array('id' => 'quotation_status', 'class' => 'form-control bm-select' , 'placeholder' => ''))}}
				@if ($errors->has('quotation_status')) <p class="bg-danger">{{ $errors->first('quotation_status') }}</p> @endif
			</div> <!-- vendor end -->  
		</div>	
		...
		<div class="col-md-4">  <!-- column 1 -->
			<div class="form-group text-input"> <!-- from date -->  
				...
				{{ Form::text('fromdate', Input::get('fromdate'), array('id' => 'fromdate', 'class' => 'form-control', 'placeholder' => ''	)) }}			
		...
		<div class="col-md-4">  <!-- column 2 -->
			<div class="form-group text-input"> <!-- to date -->  
				...
				{{ Form::text('todate', Input::get('todate'), array('id' => 'todate', 'class' => 'form-control' , 'placeholder' => '')) }}			
		...
		<div class="col-md-12">  <!-- column 4 -->
			<div class="form-group text-input"> <!-- vendor -->  
				...
				{{ Form::text('search', Input::get('search'),array('id' => 'search', 'class' => 'form-control', 'placeholder' => ''))}}
	...
	@endif
	@if (isset($quotations))
		@include('quotations.table', ['quotations' => $quotations, 'title' => isset($pendingtitle) ? $pendingtitle : ''])
	@endif
